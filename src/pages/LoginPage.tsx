    ...
    <div className="flex flex-col items-center justify-center h-full gap-4 mt-20">
      <div className="flex flex-col gap-3">
        <input
          {...getInputProps("email")}
          name="email"
          className={`border border-[#ccc] w-[300px] p-[10px] focus:border-[#807dff] rounded-sm outline-none ${errors?.email && touched?.email ? "border-red-500 bg-red-200" : "border-gray-300"
            }`}
          type={"email"}
          placeholder={"이메일"}
        />
        ...
        <input
          ...
          className={`border border-[#ccc] w-[300px] p-[10px] focus:border-[#807dff] rounded-sm outline-none ${errors?.password && touched?.password ? "border-red-500 bg-red-200" : "border-gray-300"
            }`}
          type={"password"}
          placeholder={"비밀번호"}
        />
